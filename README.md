...
This project contains both software and data, which are released under different licenses.

### Code

The website code, scripts, and other software in this repository are released under the **MIT License**.

### Data

The pardon and clemency dataset compiled by Pardonpedia is released under the **Creative Commons Attribution 4.0 International License (CC-BY-4.0)**.

You are free to use, share, and adapt the data for any purpose, including journalism, research, and commercial use, provided appropriate credit is given to **Pardonpedia**.
